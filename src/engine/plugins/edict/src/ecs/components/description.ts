 ...
 *
 * you can find this file at: https://github.com/desplmfao/eldritch/blob/main/src/engine/plugins/edict/src/ecs/components/description.ts
 */
...
export class ComponentDescription extends Component {
   /** a human-readable description for the command or argument */
   text!: t<str>;
}