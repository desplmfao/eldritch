 ...
 *
 * you can find this file at: https://github.com/desplmfao/eldritch/blob/main/src/engine/plugins/edict/src/ecs/components/relationship/alias/aliased_by.ts
 */
...
@Reflectable()
export class ComponentAliasedBy extends Component {
