 ...
 *
 * you can find this file at: https://github.com/desplmfao/eldritch/blob/main/src/engine/packages/guerrero/guerrero-core-strategy-native/src/codegen/propgen/collections/sparseset/index.ts
 */
...
export class DynamicSparseSetPropgen implements IPropertyCodegen {
   ...
   can_handle(
      ...
      return new TypeParser(property_layout.type).parse().kind === 'sparseset';
   }
...
`;
   ...
   generate_setter(
      ...
      return `\
   ${setter_access} ${prop_key_str}(value: SparseSet) {
