 ...
 *
 * you can find this file at: https://github.com/desplmfao/eldritch/blob/main/src/engine/packages/guerrero/guerrero-core-strategy-aos/src/runtime/skeletons/dynamic/hashmap/dynamic-hashmap-primitive-primitive.ts
 */
...
export abstract class DynamicHashMapPrimitivePrimitive<
...
> extends DynamicHashMapPrimitive<K_Public, K_Internal, V_Internal, V_Public> {
   ...
   get $entry_node_size(): number {
      ...
      const alignment = Math.max(this.$key_alignment, this.$value_alignment, POINTER_SIZE);
